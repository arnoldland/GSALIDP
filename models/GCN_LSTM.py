...
class GCN_LSTM(torch.nn.Module):
    def __init__(
        ...
        self.MLP = MLPModel(in_size=hidden_channels, hidden_size=hidden_channels, out_size=num_classes)
    ...
    def forward(self, x, edge_index, edge_weight, h=None, c=None, output=False):
